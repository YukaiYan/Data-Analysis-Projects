%% load data for Test4: Horizontal Displacement + rotation
...
% extract the location of the bucket for test4
threshold = 220;
[xpos1, ypos1] = extractLocation(vidFrames1_4, threshold, 1, false);
[xpos2, ypos2] = extractLocation(vidFrames2_4, threshold, 2, false);
[ypos3, xpos3] = extractLocation(vidFrames3_4, threshold, 3, false);
