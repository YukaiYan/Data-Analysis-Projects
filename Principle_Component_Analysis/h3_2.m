%% load data for Test2: Noisy case
...
% extract the location of the bucket for test2
threshold = 220;
[xpos1, ypos1] = extractLocation(vidFrames1_2, threshold, 1, false);
[xpos2, ypos2] = extractLocation(vidFrames2_2, threshold, 2, false);
[ypos3, xpos3] = extractLocation(vidFrames3_2, threshold, 3, false);
...
for i = 1:numFrames
    ...
    elseif (camera == 2)
        binaryImage = imcrop(binaryImage,[222.5 64.5 200 361]);
        % remove extra white space located on the topleft
        for x = 1:100
            for y = 1:100
                binaryImage(x,y) = 0;
    ...
    elseif (camera == 3)
        binaryImage = imcrop(binaryImage,[206.5 132.5 400 268]);    
    end
